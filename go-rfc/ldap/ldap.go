...
// OIDAssociatedName 0.9.2342.19200300.100.1.38	associatedName	Attribute Type (see RFC 4524)
var OIDAssociatedName = asn1.ObjectIdentifier{iTUTT, data, pSS, uCL, pilot, pilotAttributeType, associatedName}
